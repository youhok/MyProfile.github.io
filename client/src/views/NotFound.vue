    ...
    <div class="errorWrap">
        <svg viewBox="0 0 1920 1080" xmlns="http://www.w3.org/2000/svg">
            ...
            <g data-name="Layer 2" id="fortyfour">
                <g class="four a">
                    <rect class="cls-2" height="466.29" rx="57.1" ry="57.1" transform="translate(918.39 330.19) rotate(90)"
                        width="120.71" x="233.74" y="391.14"></rect>
            ...
            <g data-name="Layer 3" id="umbrella">
                <g>
                    ...
                    <g>
                        <rect class="cls-4" height="5.1" transform="translate(108.21 955.38) rotate(-49.71)" width="175.58"
                            x="997.45" y="358.35"></rect>
                        <rect class="cls-4" height="32.27" rx="10.73" ry="10.73"
                            transform="translate(515.04 -573.16) rotate(40.29)" width="21.46" x="1028.09" y="399.36"></rect>
                    </g>
                </g>
            </g>
            ...
            <g data-name="Layer 7" id="cup">
                ...
                <g class="cls-10">
                    ...
                    <path class="cls-8"
                        d="M1172.73,709.7l23.58-23.85a4.19,4.19,0,0,1,5.92,0h0a4.19,4.19,0,0,1,0,5.92l-23.58,23.85Z"></path>
                    <path class="cls-8"
                        d="M1185.11,722.09l23.58-23.85a4.19,4.19,0,0,1,5.92,0h0a4.19,4.19,0,0,1,0,5.92L1191.06,728Z"></path>
                </g>
                <path class="cls-5"
            ...
            <g data-name="Layer 5" id="bike">
                ...
                <g>
                    <rect class="cls-1" height="53.21" transform="translate(-165.97 273.38) rotate(-16.19)" width="12.87"
